...
python evaluation.py \
    ...
    --save_detailed \
    --output_file_name table1-DiscriTune-COCO-CC-final.json

echo ""
echo "DiscriTune Evaluation on Conceptual Captions completed!"
echo "Results saved to eval_results_cc/table1-DiscriTune-COCO-CC.json"
